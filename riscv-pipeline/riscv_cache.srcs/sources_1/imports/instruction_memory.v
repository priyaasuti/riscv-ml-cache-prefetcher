...
initial begin
    ...
    //  [8]  beq x1,x2,+8 - NOT taken (x1=5, x2=3, 5?3)
    //       Encoding: B-type, rs1=x1, rs2=x2, imm=+8, funct3=000
    memory[8]  = 32'h00208463;
    //  [9]  addi x6, x0, 1  -> x6=1   (this IS executed)
    memory[9]  = 32'h00100313;
    //  [10] nop
